...
Full production-ready Prolog backend with explicit CORS handling
==============================================
*/
...
handle_options(Request) :-
    cors_enable(Request, [methods([get,post,options]), origins(['http://localhost:3000']), headers(['content-type'])]),
